...
<head>
	...
	<link rel="stylesheet" type="text/css" href="css/manageuserss.css">
	...
	<script src="js/manage_userss.js"></script>
	<script>
...
<main>
	<h1 class="slideInDown animated">Add a new User or update User </h1>
	<div class="form-style-5 slideInDown animated">
		<form enctype="multipart/form-data">
			...
			<fieldset>
				...
				<input type="text" name="password_user" id="password_user" placeholder="password_user...">
			</fieldset>
			<fieldset>
